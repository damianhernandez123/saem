...
<div class="row">
    ...
    <div class="col-12">
        <div class="card card-border-success">
            <div class="card-header bg-white cfos"> <h4 class="float-left">Listado de Aulas</h4> <span class="float-right"><a href="core_Aulas_addAulas.php" class="btn btn-success btn-sm">Agregar nuava aula <i class="pe-7s-plus"></i></a></span></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-2">
